...
Step 7: From the AOI, use the Ctrl+W command to open the declare box which will fill in the data type automatically. 3 times doing this (max) and all errors should dissapear in the rung.
